...
class Model extends BaseModel
{
    ...
    protected function doFindAll(int $limit = 0, int $offset = 0)
    {
        ...
        // Pastikan $this->tempReturnType tidak null, beri nilai default 'array' jika null
        $returnType = $this->tempReturnType ?? 'array';  // Default ke 'array' jika null

        return $builder->limit($limit, $offset)
            ->get()
            ->getResult($returnType);  // Gunakan $returnType yang sudah terisi dengan nilai yang valid
    }
