	...
	public function delete($id)
{
    ...
    if ($akun) {
        ...
        return redirect()->to('/admin/akun_pendaftar')->with('success', 'Akun berhasil dihapus');
    } else {
        // Jika akun tidak ditemukan
        return redirect()->to('/admin/akun_pendaftar')->with('error', 'Akun tidak ditemukan');
    }
}
}