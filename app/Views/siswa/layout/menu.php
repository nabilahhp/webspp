  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        ...
        $gambar = !empty($gambar) ? $gambar : 'user2-160x160.jpg';  // default image kalau kosong
        $srcGambar = base_url('assets/admin/dist/img/' . $gambar);
        ?>
        <img src="<?= $srcGambar ?>" class="img-circle elevation-2" alt="User Image">
      </div>
      <div class="info">
