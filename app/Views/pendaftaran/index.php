    ...
    <div class="container pt-12 pt-md-16 pb-21 pb-md-21 text-center">
        <div class="row">
            <div class="col-md-10 col-lg-10 col-xl-10 mx-auto">
                ...
                <h4><span class="text-warning">1. Pembuatan Akun</span> <i class="fa fa-chevron-right text-secondary"></i> <span class="text-secondary">2. Pendaftaran Berhasil</span></h4>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-8 col-xl-8 col-xxl-8 mx-auto mt-n20">
                <div class="card">
                    <div class="card-body p-11">
                        <h2 class="mb-3 text-start">Membuat Akun Pembayaran SPP <?php echo $this->website->namaweb() ?></h2>
                        ...
                        <div class="form-floating mb-4">
                            ...
                            <label for="loginEmail" class="text-primary">Email Aktif</label>
                        </div>
...
<!-- Script Pop-up dan Redirect ke Login -->
<script>
    <?php if (session()->getFlashdata('sukses')) : ?>
        // Tampilkan alert dengan pesan sukses
        alert('Pendaftaran Anda berhasil! Anda akan diarahkan ke halaman login.');

        // Redirect ke halaman login setelah 2 detik
        setTimeout(function() {
            window.location.href = 'http://localhost/webspp/signin';  // URL login Anda
        }, 7000);  // Redirect setelah 2 detik
    <?php endif; ?>
</script>
